...
<div class="container-wrapper">
   <div class="container">
      ...
      <!-- addProduct.jsp 파일의 submit버튼을 눌렀을 때, post방식으로 AdminController.editProduct()메서드 호출  -->
      <sf:form action="${pageContext.request.contextPath}/admin/productInventory/editProduct"
